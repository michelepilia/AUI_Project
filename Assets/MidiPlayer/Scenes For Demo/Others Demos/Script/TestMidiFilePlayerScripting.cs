        ...
        void OnGUI()
        {
            ...
            if (midiFilePlayer != null)
            {
                ...
                GUILayout.Label(string.Format("Played: {0} Active: {1} Free: {2} Reused: {3} %",
                    midiFilePlayer.MPTK_StatVoicePlayed, midiFilePlayer.MPTK_StatVoiceCountActive, midiFilePlayer.MPTK_StatVoiceCountFree, Mathf.RoundToInt(midiFilePlayer.MPTK_StatVoiceRatioReused)),
